...
### 考试与日程
- 📝 **考试全屏倒计时** — 科目名称/剩余时间/进度条/下一场信息，最后5分钟蜂鸣提醒，15分钟覆盖层提醒
...
- 📢 **下课大字覆盖层** — 距下课1分钟屏幕居中大字倒计时，下课弹大字提示，3秒消失
...
├── ClassOverlayWindow.xaml  # 下课/提醒大字覆盖层 UI
├── ClassOverlayWindow.xaml.cs# 下课/提醒大字覆盖层逻辑
...
4. **课表栏**：托盘菜单 → 课表栏，悬浮屏幕顶部，上课自动收缩；距下课1分钟屏幕弹出大字倒计时
5. **考试模式**：设置 → 📝 考试 → 添加考试+科目 → 托盘菜单 → 考试模式进入全屏
6. 空闲时双击考试窗口或按 F11 切换窗口模式
7. 考试最后5分钟有蜂鸣提醒，15分钟弹出覆盖层提醒，考试结束自动恢复课表栏
